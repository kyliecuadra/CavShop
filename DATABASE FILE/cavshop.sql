...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2025 at 04:08 AM
...
(29, 'Amount', 'Amount'),
(30, 'Pick-up Status', 'Pick-up Status'),
...
(0, 95, 'Bose QuietComfort 45 Bluetooth Wireless Headphones', 'One Size for All', 'Black', '1', '279', '1736391404'),
...
(1, 'About Us', '<p>Welcome to CavShop, the official eCommerce platform of Cavite State University! Our mission is to provide a seamless online shopping experience for students, faculty, alumni, and supporters of CvSU.</p><p>At CavShop, we aim to foster a sense of community and school pride by offering a wide selection of high-quality Cavite State University merchandise. From books and uniforms to souvenirs and collectibles, we are dedicated to making CvSU essentials easily accessible to everyone, wherever they may be.</p><p>Our goal is to support the university\'s vision of excellence and service by reinvesting in student initiatives and university programs through every purchase. By shopping at CavShop, you are not only getting authentic CvSU products but also contributing to the continued growth and success of the Cavite State University community.</p><p>Let’s celebrate the spirit of CvSU—together!</p>\r\n', 'about-banner.jpg', 'CavShop - About Us', 'Cavite State University, CvSU, CavShop, CvSU merchandise, Cavite State University books, CvSU uniforms, CvSU souvenirs, Cavite State University online store, CvSU eCommerce, CvSU collectibles, Cavite State University memorabilia, buy CvSU items, official CvSU store, Cavite State University shop, CvSU pride, Cavite State University apparel', 'Shop for Cavite State University books, uniforms, souvenirs, and more at CavShop. Get authentic CvSU merchandise and celebrate your school pride while supporting the university. Convenient online shopping for students, alumni, and supporters.\r\n', 'FAQ', 'faq-banner.jpg', 'CavShop - FAQ', '', '', 'Blog', 'blog-banner.jpg', 'Ecommerce - Blog', '', '', 'Contact Us', 'contact-banner.jpg', 'CavShop - Contact', '', '', 'Photo Gallery', 'pgallery-banner.jpg', 'Ecommerce - Photo Gallery', '', '', 'Video Gallery', 'vgallery-banner.jpg', 'Ecommerce - Video Gallery', '', '');
...
(0, 1, 'Liam Moore', 'liam@mail.com', '2025-01-09 10:56:44', '', 279, '', '', '', '', '', 'Walk-in', 'Pending', 'Pending', '1736391404'),
...
CREATE TABLE `tbl_settings` (
  ...
  `total_recent_post_footer` tinyint(3) NOT NULL,
  `total_popular_post_footer` tinyint(3) NOT NULL,
  `total_recent_post_sidebar` tinyint(3) NOT NULL,
  `total_popular_post_sidebar` tinyint(3) NOT NULL,
  `total_featured_product_home` tinyint(3) NOT NULL,
  `total_latest_product_home` tinyint(3) NOT NULL,
  `total_popular_product_home` tinyint(3) NOT NULL,
...
(1, 'slider-1.png', 'Welcome to CavShop', 'Your one-stop online store for Cavite State University books, uniforms, souvenirs, and more—celebrating your Cavite State pride with every purchase!', 'Shop Now', '', 'Center'),
...
(0, 'kyliecuadra@gmail.com', '2025-01-08', '2025-01-08 00:16:14', 'b32cdb1d83066adf89040ee55f9066f6', 0);
